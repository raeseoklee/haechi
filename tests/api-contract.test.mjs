...
const FROZEN_EXPORTS = {
  ...
  "./crypto": { module: crypto, names: ["createLocalCryptoProvider", "initLocalKeyFile", "assertCryptoProviderConformance", "canonicalize", "canonicalizeCryptoAad", "CRYPTO_AAD_ENCODING_V2", "readNonceBudget"] },
