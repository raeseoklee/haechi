...
권위 있는 항목별 등록부는 `docs/current/code-review-risk-register-2026-06-16.ko.md`입니다. 이 절은 릴리스 게이트 요약입니다. `P0-CR-001`, `P1-CR-002`, `P1-CR-003`, `P1-CR-004`, `P1-CR-005`는 **Resolved**입니다(1.3.1 대상 프록시 보안 패치, SSRF IPv4-mapped 정규화, streaming-inspection 텍스트 검사 수정); `P2-CR-013`도 같은 streaming 변경으로 **Resolved**입니다. 남은 P2 항목은 해결되거나 책임자 근거와 함께 명시 수용되기 전까지 새 GitHub release tag와 npm publish를 차단합니다.
