...
export const INLINE_PATTERNS = [
  ...
  },
  {
    ...
    message: "stale support window 'Only the current 0.3.x' (current line is 1.3.x)"
  },
  {
    id: "haechi-0.3.x",
    re: /\bHaechi 0\.3\.x\b/i,
    message: "stale version label 'Haechi 0.3.x' (current line is 1.3.x)"
  },
  {
  ...
  },
  {
    ...
    re: /\bin 0\.3\.x\b/i,
    message: "stale current-behavior version token 'in 0.3.x' (current line is 1.3.x)"
  }
];
...
export const FRONTMATTER_PATTERNS = [
  ...
  },
  {
    ...
    message: "stale front-matter 'Target version: 0.6.0' on a living doc (current line is 1.3.x)"
  },
  {
    id: "target-version-1.0.0",
    re: /^\s*-\s*(?:Target version|기준 버전):\s*1\.0\.0\b/i,
    message: "stale front-matter 'Target version: 1.0.0' on a living doc (current line is 1.3.x)"
  }
];
